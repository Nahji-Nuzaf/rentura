      ...
      <div className={`drawer${drawer ? ' open' : ''}`}>
        ...
        <div className="dr-body">
          ...
          <div className="section-divider">
            ...
            <div className="field">
              <label>Address <span style={{ fontWeight: 400, color: '#94A3B8', textTransform: 'none', letterSpacing: 0 }}></span></label>
              <input
                value={form.address}
            ...
            <div className="field-row">
              <div className="field">
                <label>City <span style={{ fontWeight: 400, color: '#94A3B8', textTransform: 'none', letterSpacing: 0 }}></span></label>
                <input
                  value={form.city}
              ...
              <div className="field">
                <label>Property Type <span style={{ fontWeight: 400, color: '#94A3B8', textTransform: 'none', letterSpacing: 0 }}></span></label>
            ...
            <div className="field-row">
              ...
              <div className="field">
                <label>Deposit Amount <span style={{ fontWeight: 400, color: '#94A3B8', textTransform: 'none', letterSpacing: 0 }}></span></label>
                <input
                  type="number" min="0"
