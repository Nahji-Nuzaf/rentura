...
export default function UpgradePage() {
  ...
  const annualPrice  = Math.round(monthlyPrice * 10) / 12  // ~$8.32
  ...
  useEffect(() => {
    const load = async () => {
      ...
      if (params.get('success')==='true') {
        showToast('🎉 Payment successful! Your plan has been upgraded to Pro.','success')
        window.history.replaceState({},'','/landlord/upgrade')
        // Re-fetch plan after short delay (webhook may take a moment)
        setTimeout(async () => {
  ...
  async function handleUpgrade(plan: 'pro'|'business') {
    ...
    if (!priceId) {
      showToast('Plan not configured yet. Please contact support.','error'); return
    }
    ...
    <>
      <style>{`
        ...
        *,*::before,*::after{margin:0;padding:0;box-sizing:border-box}
        ...
        /* PRO ACTIVE BANNER */
        .pro-active-banner{background:linear-gradient(135deg,#0F172A,#1a3354);border:1px solid rgba(59,130,246,.3);border-radius:18px;padding:24px 28px;margin-bottom:32px;display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:16px;max-width:960px;margin-left:auto;margin-right:auto}
        ...
        /* SANDBOX BANNER */
        .sandbox-banner{background:#FEF9C3;border:1px solid #FDE68A;border-radius:12px;padding:12px 18px;margin-bottom:24px;font-size:13px;color:#D97706;font-weight:600;display:flex;align-items:center;gap:8px;max-width:960px;margin-left:auto;margin-right:auto}
        ...
        .plan-cta.biz-current{background:rgba(255,255,255,.08);color:#CBD5E1;border:1px solid rgba(255,255,255,.1);cursor:default}
        ...
        <div className="main">
          ...
          <div className="content">
              ...
              <div className="pro-active-banner">
                <div className="pab-left">
                  ...
                  <div>
                    ...
                    <div className="pab-sub">All Pro features are unlocked. Enjoy unlimited properties, exports & analytics.</div>
                  </div>
                </div>
            ...
            <div className="sandbox-banner">
              🧪 Stripe Sandbox Mode &nbsp;·&nbsp; Test card: <strong style={{margin:'0 4px'}}>4242 4242 4242 4242</strong> &nbsp;·&nbsp; Any future date &nbsp;·&nbsp; Any 3-digit CVC &nbsp;·&nbsp; No real charge
            </div>
            ...
            <div className="plans">
              ...
              <div className="plan featured">
                ...
                <div className="plan-billed" style={{color:'#64748B'}}>
                  {billing==='annual'
                    ?`Billed $${(annualPrice*12).toFixed(2)}/year — save $${((monthlyPrice-annualPrice)*12).toFixed(2)}`
                    :'Billed monthly'}
                </div>
            ...
            {!isPro&&(
              <div className="bottom-cta">
                ...
                <button className="bc-btn" disabled={!!loadingPlan} onClick={()=>handleUpgrade('pro')}>
                  {loadingPlan==='pro'?'⏳ Redirecting to Stripe...':'⭐ Get Rentura Pro →'}
                </button>
                <div className="bc-note">Test card: 4242 4242 4242 4242 · Any future date · Any CVC</div>
              </div>
            )}
